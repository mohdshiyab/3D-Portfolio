...
export const Encryption = () => {
  return (
    <div className="flex flex-row relative items-center justify-center min-h-screen w-full h-full -z-20 px-4">
      <div className="absolute w-full h-auto top-0 z-[5] px-4">
        <motion.div
          variants={slideInFromTop}
          className="text-3xl sm:text-4xl md:text-[40px] font-medium text-center text-gray-200"
        >
          Performance{" "}
      ...
      <div className="absolute z-[20] bottom-[10px] px-4 w-full">
